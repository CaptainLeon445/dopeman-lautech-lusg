...
const CAMPAIGN_PICTURES = [
  { src: campaign01, alt: "DOPEMAN and Team New Dawn on the campaign trail at LAUTECH" },
  { src: campaign02, alt: "DOPEMAN walking with the campaign team on campus" },
  { src: campaign03, alt: "Team New Dawn volunteers in DOPEMAN branded t-shirts during a campus clean-up" },
  { src: campaign04, alt: "Team New Dawn holding \"Support the New Dawn 26\" and \"Vote Famakin\" campaign banners" },
  { src: campaign05, alt: "Team New Dawn volunteers cleaning up around the Students' Union Government building at LAUTECH" },
  { src: campaign06, alt: "Team New Dawn candidates on stage at a campaign event" },
  { src: campaign07, alt: "Close-up of DOPEMAN and campaign team members on the campaign trail" },
  { src: campaign08, alt: "Team New Dawn volunteers doing a clean-up exercise at the SUG building" },
  { src: campaign09, alt: "Team New Dawn distributing New Dawn flyers to students on campus" },
  { src: campaign10, alt: "Portrait of DOPEMAN with campaign team members outdoors" },
  { src: campaign11, alt: "Team New Dawn members backstage at a campaign event" },
  { src: campaign12, alt: "Team New Dawn volunteers during a park clean-up exercise" },
];
